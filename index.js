...
async function getCopySuggestion(productName, productDesc, productTarget) {
  const response = await openai.createCompletion({
    ...
    prompt: `Use a product name, a product description and a target market to create advertising copy for a product.
            ...
            ###
            product name: 1911 pistial - New model
            product description: A lengend gun designed in 1911 and now back to market with a new deisgn
            product traget market: US
            advertising copy: your dream gun which you could find in the market. Your parents may have had it when you are kids. And now you are the luck guy as we have resigned the model with lost of new feastures. You can use it for fun shooting at range, and you can use it for home protection, and many other usage. Buy now! 
            ###
